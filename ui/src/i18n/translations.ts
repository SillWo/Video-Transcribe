...
const en = {
  ...
  controls: {
    ...
    sourceCheck: {
      title: 'Source check',
      description: 'Validate the URL with yt-dlp before starting transcription.',
      hint: 'No media is downloaded here. The backend only requests metadata and available formats.',
      actions: {
      ...
      messages: {
        idle: 'Run the check to confirm that yt-dlp can read this source.',
        checking: 'Checking metadata, extractor, and available formats.',
        requestFailed: 'Unable to complete the source check request.',
      },
      fields: {
        title: 'Title',
        ...
        kind: 'Source type',
        formatSample: 'Format preview',
        details: 'Technical details',
      },
      values: {
        unavailable: 'Unavailable',
        noFormats: 'No formats returned',
        formatsReady: '{count} format(s) available',
        audioReady: 'Audio-capable formats found',
        audioMissing: 'Audio-capable formats not found',
        playlist: 'Playlist, checked {count} item(s)',
        single: 'Single item',
      },
    },
  },
...
const ru: TranslationSchema = {
  ...
  controls: {
    ...
    buttons: {
      ...
      checkingSource: 'Проверка',
      starting: 'Запуск',
      start: 'Начать расшифровку',
    },
    sourceCheck: {
      title: 'Проверка источника',
      description: 'Проверьте URL через yt-dlp до запуска расшифровки.',
      hint: 'Медиа здесь не скачивается. Backend запрашивает только метаданные и наличие форматов.',
      actions: {
      ...
      status: {
        ...
        failed: 'Найдена проблема',
      },
      messages: {
        idle: 'Запустите проверку, чтобы понять, сможет ли yt-dlp обработать источник.',
        checking: 'Проверяем метаданные, extractor и доступные форматы.',
        requestFailed: 'Не удалось выполнить запрос проверки источника.',
      },
      fields: {
        title: 'Название',
        extractor: 'Extractor / сайт',
        id: 'ID источника',
        formats: 'Форматы',
        audio: 'Извлечение аудио',
        kind: 'Тип источника',
        formatSample: 'Примеры форматов',
        details: 'Технические детали',
      },
      values: {
        unavailable: 'Недоступно',
        noFormats: 'Форматы не найдены',
        formatsReady: 'Доступно форматов: {count}',
        audioReady: 'Форматы с аудио найдены',
        audioMissing: 'Форматы с аудио не найдены',
        playlist: 'Плейлист, проверено элементов: {count}',
        single: 'Одиночный источник',
      },
    },
  },
  panels: {
